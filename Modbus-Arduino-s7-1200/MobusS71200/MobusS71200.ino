...
void setup()
{
  ...
  uint8_t ip[]      = { 192, 168, 15, 25 };
  uint8_t gateway[] = { 192, 168, 15, 1 };
...
{
  Mb.Run();
  /// tA CO THE GAN VA NHAP GIA TRI CUA CAC THANH GHI DU LIEU VAO M NHA ANH E
  // O DAY TA THU GUI CHUOI GOM 10 THANH GHI NHA
