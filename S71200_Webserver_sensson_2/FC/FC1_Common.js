// hàm chức năng để khi bắt đầu chạy trang html chỉ hiển thị trang home thoi nha
window.onload = function() {
    var homePage = document.getElementById('ScreenMain');
    // homePage.classList.add('active');
    document.getElementById("Screen_1").style.visibility= 'hidden';   // an trang 1
    document.getElementById("Screen_2").style.visibility= 'hidden';   // an trang 2
};

// hàm chức năng chuyển  trang
function fn_ScreenChange(src_1,scr_2,scr_3)
{
...
setInterval(function () {
    if(tag_Edit_Enable == false)
    {
     ...
     // hien thi trang thái của symbol dua tren biến integer của plc nha 
     fn_SymbolStatus('Pump_1','Pump1',"tag_Integer")
}, 1000);
...
// tso ham chuc nang hhien thi trang thai symbol
function fn_SymbolStatus(ObjectID,Symname,Tag)
{
    var imglink_0="images/Symbol/"+ Symname + "_0.png"; // trạng thái của tag 0
    var imglink_1="images/Symbol/"+ Symname + "_1.png"; // trạng thái của tag 1
    var imglink_2="images/Symbol/"+ Symname + "_2.png"; // trạng thái của tag 2
    var imglink_3="images/Symbol/"+ Symname + "_3.png"; // trạng thái của tag 3
    var imglink_4="images/Symbol/"+ Symname + "_4.png"; // trạng thái của tag 4
    var imglink_5="images/Symbol/"+ Symname + "_5.png"; // trạng thái của tag 3
